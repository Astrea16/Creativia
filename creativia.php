<?php
	...
	function send_form($message) {
		...
		$mail_to = "7jatan@ggmail.com"; // Адрес, куда отправляем письма
		$subject = "Feedback letter"; // Тема письма
	...
	if(empty($errors)) { // Отправляем форму если нет ошибок
		...
		$msg_result = "Message sent successfully!"; // Сообщение об успешной отправке
